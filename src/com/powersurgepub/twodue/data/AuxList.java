...
/**
   An auxiliary list of To Do Items. <p>
  
   This code is copyright (c) 2004 by Herb Bowie.
   All rights reserved. <p>
  
   Version History: <ul><li>
      2004/02/24 - Originally written.
       </ul>
...
public class AuxList 
   ...
   */
	public AuxList (TwoDueCommon td) {
    this.td = td;
  ...
  /**
    Sets the sorted collection of ToDoItems to be used by this object.
   
    @param sorted Sorted collection of ToDoItems.
   */
   ...
   */
    ...
    for (int i = 0; i < sorted.size(); i++) {
      ...
      if ((StringUtils.indexOfIgnoreCase (findLower, findUpper,
          next.getAssignedTo(), 0) >= 0)
          || (StringUtils.indexOfIgnoreCase (findLower, findUpper,
              next.getTags().toString(), 0) >= 0)
          || (StringUtils.indexOfIgnoreCase (findLower, findUpper,
              next.getDescription(), 0) >= 0)
          || (StringUtils.indexOfIgnoreCase (findLower, findUpper,
              next.getOutcome(), 0) >= 0)
          || (StringUtils.indexOfIgnoreCase (findLower, findUpper,
              next.getTitle(), 0) >= 0)
  ...
  /**
    ...
    @param  index The index pointing to an item in the 
                  underlying ToDoItems collection.
   */
