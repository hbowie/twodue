...
/**
   A panel to display most information about a To Do item. <p>
  
   This code is copyright (c) 2003 by Herb Bowie.
   All rights reserved. <p>
  
   Version History: <ul><li>
      2004/06/27 - Changed to display a status of PENDING_RECURS (8)
                   as Closed. <li>
   ...
   @version 2004/07/05 - Modified to preserve line breaks and quotation marks
                         in the description and outcome fields. 
